...
<head>
    ...
    <link rel="stylesheet" href="../Dashboard/css/create-lead.css?v=2" />
</head>
...
<button class="btn btn-secondary" id="saveContinueBtn" type="button">
    ...
    <script src="../Dashboard/js/sweetalert2.min.js" data-swal="true"></script>
    <script>window.CRM_ROLE = 'admin';</script>
    <script src="../Dashboard/js/app.js?v=4"></script>
    <script src="../Dashboard/js/create-lead.js?v=7"></script>
  </body>
