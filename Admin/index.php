...
<html lang="en">
  <head>
    ...
    <meta name="description" content="ICSS CRM Dashboard — Admin overview of leads, admissions, revenue and followups." />
    <title>Admin Dashboard | ICSS CRM</title>
    ...
    <link rel="stylesheet" href="../Dashboard/css/dashboard.css?v=3" />
  </head>
  ...
  <body>
                            ...
                            <div class="user-cell-avatar">
                              <?php
                                ...
                                foreach (preg_split('/\s+/', $name) as $p) {
                                  if ($p !== '') { $leadInitials .= strtoupper($p[0]); }
                                  if (strlen($leadInitials) >= 2) break;
                                }
                                echo htmlspecialchars($leadInitials ?: 'U');
                              ?>
                            </div>
    ...
    <script src="../Dashboard/js/dashboard.js?v=4"></script>
  </body>
</html>
